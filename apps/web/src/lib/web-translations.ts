...
export const WEB_TRANSLATIONS = {
  ko: {
    ...
    settings: { title: '설정', navLabel: '설정 메뉴', branding: '브랜딩', language: '언어', languageTitle: '언어 설정', languageDescription: '서비스에서 사용할 언어를 선택하세요. 모든 화면에 적용됩니다.', preference: '선호 언어', korean: '한국어 (Korean)', english: 'English', previewTitle: '실시간 미리보기', previewDashboard: '대시보드', previewEmail: '완료 알림 이메일', previewStatus: '서명 대기 중', previewAction: '새 계약 보내기', previewEmailSubject: '[계약 완료] 계약서 서명이 완료되었습니다', cancel: '취소', save: '변경사항 저장', saving: '저장 중…', saved: '언어 설정이 저장되었습니다.', saveFailed: '언어 설정을 저장하지 못했습니다. 다시 시도해 주세요.', retry: '다시 시도', theme: '테마', themeTitle: '테마 설정', themeDescription: '화면을 밝게 볼지 어둡게 볼지 골라요. 이 기기뿐 아니라 로그인한 모든 곳에 적용돼요.', themeLight: '밝게', themeDark: '어둡게', themeSystem: '시스템 설정 따름', themeSystemHint: '기기의 화면 모드를 따라가요.', themeSaved: '테마 설정을 저장했어요.', themeSaveFailed: '테마 설정을 저장하지 못했어요. 다시 시도해 주세요.' },
